...
import com.cydeo.Dish;
import com.cydeo.DishData;
...
public class FindingMatching {
    public static void main(String[] args) {
        //All MATCH
       boolean isHealthy= DishData.getAll().stream().allMatch(dish -> dish.getCalories()<100);
        ...
        List<String>list1= Arrays.asList("Jhonny","David","Jack","Duke","Jill","Julia","Jenish","Divya");
        List<String>list2= Arrays.asList("Jhonny","David","Jack","Duke","Jill","Julia","Jenish","Divya");
   ...
   Optional<String>findAny=list1.parallelStream().filter(s -> s.startsWith("J")).findAny();
        ...
        Optional<String>findAny1=list1.parallelStream().filter(s -> s.startsWith("J")).findAny();
